...
**🗄️ Database (MongoDB):** [database.py](Backend/database.py) (connection + helpers) · [seed.py](Backend/seed.py) (collections, indexes & seed data) — owns collections: `users`, `user_sessions`, `password_recovery_tokens`, `user_ratings`, `help_tickets`.
